...
using ITLecChartGuy.AdvancedChartEditor.Helpers;
using System;
                ...
                WorkAsync(new WorkAsyncInfo
                {
                    ...
                    PostWorkCallBack = evt =>
                    {
                        ...
                        else
                        {
                            ...
                            foreach(var entity in charts.Entities)
                            {
                                string chartType = "System";
                                if(entity.Attributes.Contains("userqueryvisualizationid"))
                                {
                                    chartType = "User";
                                }
