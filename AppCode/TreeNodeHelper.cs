...
namespace ITLec.CRMChartGuy.AppCode
{
    ...
    internal class TreeNodeHelper
    {
        ...
        public static void AddTreeViewNode(object parentObject, XmlNode xmlNode, ChartEditorHelper form, bool isDisabled = false)
        {
            ...
            if (xmlNode.NodeType != XmlNodeType.Text)
            {
                foreach (XmlAttribute attr in xmlNode.Attributes)
                {
                    ...
                    {
                        ChartEditorHelper.ChartType = attr.Value;
                    }
                }
